package com.krissmile31.mockproject.nav.songs.tab.genres.adapter;
...
public class GenresAdapter extends RecyclerView.Adapter<GenresAdapter.MyViewHolder> {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        private TextView mTvGenres, mNumSongsGenres;
        ...
        public MyViewHolder(@NonNull View itemView, Context context) {
            ...
            mNumSongsGenres = itemView.findViewById(R.id.quantity_songs_genres);

        }

        public void bind(Genre genre) {
            Picasso.get().load(genre.getThumbnailGenre())
                    .placeholder(R.drawable.ic_logo)
                    .error(R.drawable.ic_logo)
                    .fit()
                    .into(mThumbnailGenres);
            mTvGenres.setText(genre.getGenreName());
            mNumSongsGenres.setText(56 + " Songs");
        }
    }
}
