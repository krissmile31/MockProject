package com.krissmile31.mockproject.view.nav.songs.tab.artists.artistdetails.adapters;
...
public class TopAlbumsAdapter extends RecyclerView.Adapter<TopAlbumsAdapter.MyViewHolder> {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View itemView = LayoutInflater.from(context).inflate(R.layout.top_albums_item,
                parent, false);
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bind(Song song) {
            mThumbnailAlbum.setImageResource(song.getThumbnails());
